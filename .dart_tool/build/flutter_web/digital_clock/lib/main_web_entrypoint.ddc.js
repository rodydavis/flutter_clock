define(['dart_sdk', 'packages/digital_clock/main'], function(dart_sdk, packages__digital_clock__main) {
  'use strict';
  ...
  const main = packages__digital_clock__main.main;
  ...
  dart.trackLibraries("packages/digital_clock/main_web_entrypoint", {
    "package:digital_clock/main_web_entrypoint.dart": main_web_entrypoint
  }, {
